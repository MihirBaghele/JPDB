  ...
  const handleGetAllAPiData = async (): Promise<void> => {
    ...
    if (cardType == 'Originator Volume') {
      ...
      if (filteredApiValue && filteredApiValue.length) {
        // FIX: Map rowOrgvolfactor using 'value' property
        ...
        // FIX: Map rowOriginatorMarketSize using 'value' property
        ...
        // FIX: Map rowOriginatorMarketSizeAfter using 'value' property
    ...
    if (cardType == 'Originator Price') {
      ...
      if (filteredApiValue && filteredApiValue.length) {
        // FIX: Map rowOrgpricefactor - prioritize 'value' over 'price'
        ...
        // FIX: Map rowOriginatorExfactorPrice - prioritize 'value' over 'price'
